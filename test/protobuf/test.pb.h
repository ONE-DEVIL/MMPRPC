...
// repeated .fixbug.User friend_lists = 2;
inline int GetFriendListResponse::_internal_friend_lists_size() const {
  return friend_lists_.size();
}
inline int GetFriendListResponse::friend_lists_size() const {
  return _internal_friend_lists_size();
}
inline void GetFriendListResponse::clear_friend_lists() {
  friend_lists_.Clear();
}
inline ::fixbug::User* GetFriendListResponse::mutable_friend_lists(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.friend_lists)
  return friend_lists_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListResponse::mutable_friend_lists() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponse.friend_lists)
  return &friend_lists_;
}
inline const ::fixbug::User& GetFriendListResponse::_internal_friend_lists(int index) const {
  return friend_lists_.Get(index);
}
inline const ::fixbug::User& GetFriendListResponse::friend_lists(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.friend_lists)
  return _internal_friend_lists(index);
}
inline ::fixbug::User* GetFriendListResponse::_internal_add_friend_lists() {
  return friend_lists_.Add();
}
inline ::fixbug::User* GetFriendListResponse::add_friend_lists() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.friend_lists)
  return _internal_add_friend_lists();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListResponse::friend_lists() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponse.friend_lists)
  return friend_lists_;
}
