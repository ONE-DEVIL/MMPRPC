...
inline const ::fixbug::RequestCode& RegisterResponse::_internal_result() const {
  const ::fixbug::RequestCode* p = result_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::RequestCode*>(
      &::fixbug::_RequestCode_default_instance_);
}
inline const ::fixbug::RequestCode& RegisterResponse::result() const {
  // @@protoc_insertion_point(field_get:fixbug.RegisterResponse.result)
  return _internal_result();
}
inline ::fixbug::RequestCode* RegisterResponse::release_result() {
...
inline ::fixbug::RequestCode* RegisterResponse::_internal_mutable_result() {
...
inline ::fixbug::RequestCode* RegisterResponse::mutable_result() {
  // @@protoc_insertion_point(field_mutable:fixbug.RegisterResponse.result)
  return _internal_mutable_result();
}
inline void RegisterResponse::set_allocated_result(::fixbug::RequestCode* result) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaNoVirtual();
  if (message_arena == nullptr) {
    delete result_;
  }
